...
newsapiai_df = pd.read_csv('../../project_raw_data/filtered_full_news_newsapi_ai.csv')
...
# NewsAPI-AI-Daten
newsapiai_selected = newsapiai_df[['Title', 'Text', 'Date']].rename(columns={'Text': 'Content', 'Date': 'PublishedAt'})
...
print(f"Die Daten wurden erfolgreich zusammengefügt und gespeichert.")
