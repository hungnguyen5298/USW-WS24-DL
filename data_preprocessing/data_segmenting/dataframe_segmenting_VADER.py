'''
TODO
Chinh lai code de cac Segment khong co ban tin thi sentiment phai la 000. Bh dang bi mat het nhung Segment k co ban tin.
Co tong tat ca ?? segment?
'''
...
while current_date <= end_date:
    ...
    if current_date.weekday() < 5:  # Montag bis Freitag (0-4)
        ...
        daily_range = pd.date_range(start=day_start, end=day_end, freq='30min')
